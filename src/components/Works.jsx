...
const ProjectCard = ({
  ...
  return (
    <motion.div className="" variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <div
        className={`bg-[#1f1f1f] flex gap-5 p-5 hover:scale-110  rounded-2xl w-full ${index % 2 === 0 ? 'flex-col lg:flex-row' : 'flex-col lg:flex-row-reverse'}`}
      ...
      <div className="flex flex-col w-full justify-between">
        <div className=''>
          ...
          <div className="flex my-1 gap-2">
                    <button  onClick={() => window.open(live_link, "_blank")} className="WebBtn">
                    ...
                    <button  onClick={() => window.open(source_code_link, "_blank")} className="GithubBtn">
